#ifndef ___RX_RXINSTALL_HELP_WND_INCLUDE____
#define ___RX_RXINSTALL_HELP_WND_INCLUDE____

#include "rxskinincludes.h"
#include "rxutil.h"
class CHelpWnd : public CRXSkinDialog,public CWebBrowserEventHandler
{
public:
	CHelpWnd();
	~CHelpWnd();
