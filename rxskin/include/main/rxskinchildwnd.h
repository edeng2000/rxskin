#ifndef __RX_SKIN_CHILD_WND_INCLUDE___
#define __RX_SKIN_CHILD_WND_INCLUDE___
...
class RXSKIN_API CRXSkinChildWnd : public CRXSkinWnd
{
public:
	CRXSkinChildWnd(void);
	~CRXSkinChildWnd(void);
	...
	VOID    AddAnchor(HWND hWnd, CRXSkinResizePoint ptTopLeft, CRXSkinResizePoint ptBottomRight);
